...
3. Sample vendors, payments, journals, invoices, payroll, and bank deposit accounts for the period. Do not load the audit answer key.
...
Read the sample through the Kernel. If the Kernel returns fail-closed or a finding ID is missing, refuse the sentence and keep the Kernel status. Do not chat. Do not ask a person.
