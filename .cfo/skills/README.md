...
| cash-reconciliation-method-selection | Choose a Kernel candidate_id. Trust apply/pay identifiers. Do not invent fees or replay match_type taxonomy | Cash Reconciliation Preparer, Cash Reconciliation Reviewer | `skills/cash-reconciliation-method-selection/SKILL.md` | New | reconciliation-exception-investigation, reconciliation-evidence-validation |
| reconciliation-evidence-validation | Accept a cash tick only when Kernel evidence and pipe identifiers support the relationship | Cash Reconciliation Preparer, Cash Exception Investigator, Cash Reconciliation Reviewer | `skills/reconciliation-evidence-validation/SKILL.md` | New | cash-reconciliation-method-selection |
| reconciliation-exception-investigation | Investigate unmatched cash without inventing explanations. Payout-label Memory cannot override missing fee evidence | Cash Exception Investigator, Cash Reconciliation Reviewer | `skills/reconciliation-exception-investigation/SKILL.md` | New | cash-reconciliation-method-selection |
| bank-reference-interpretation | Read messy bank memos and processor payout labels without inventing invoice numbers | Cash Reconciliation Preparer, Cash Exception Investigator | `skills/bank-reference-interpretation/SKILL.md` | New | cash-reconciliation-method-selection |
...
| Stripe Payout Agent | Copies Kernel payout waterfall. invoice_candidates stays 0. Arithmetic is Python |
