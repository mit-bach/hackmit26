...
Wake header: `profile: chase`. If the Wake omits Profile, use this default.
...
6. `REQUEST_INTERNAL_REVIEW` for write-off or reserve: Handle `ctl-pay`.

Skill: `ar-collections-policy`.
