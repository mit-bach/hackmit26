...
1. List world personas if the vendor is not already in the packet. Copy name and address.
...
Speak as this vendor's billing desk. Short. Factual. If Memory has delay habits for this vendor, use them.
