...
Wake header: `profile: apply`. If the Wake omits Profile, use this default.

## Procedure

1. Read the path named in the Wake.
2. Load the cash-application facts for that `payment_id`.
