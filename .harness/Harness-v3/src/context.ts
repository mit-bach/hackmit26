...
Facts about the work come from the tools this Computer grants. A shell listing of files is not those tools.
`;
...
export function readActiveProfile(_computerRoot: string, _botId: string, _wakeText = ""): string {
  return "";
}
