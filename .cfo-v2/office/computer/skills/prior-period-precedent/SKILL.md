...
- If later evidence shows the prior estimate was wrong, reverse or correct the accounting and keep the old memory as history. Do not silently keep the estimate in close, forecast, or reporting.
