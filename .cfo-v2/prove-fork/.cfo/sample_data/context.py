...
class CompanyScenarioContext:
    ...
    employee_master: list[dict] = field(default_factory=list)
    user_map: list[dict] = field(default_factory=list)
    payroll_direct_deposit: list[dict] = field(default_factory=list)
    badge_access: list[dict] = field(default_factory=list)
    it_assets: list[dict] = field(default_factory=list)
    org_chart: list[dict] = field(default_factory=list)
    facilities_registry: list[dict] = field(default_factory=list)
    vendor_bank_history: list[dict] = field(default_factory=list)
    cycle_counts: list[dict] = field(default_factory=list)
    warehouse_locations: list[dict] = field(default_factory=list)
    legal_entity_register: list[dict] = field(default_factory=list)
    contractors: list[dict] = field(default_factory=list)
    stripe_transfers: list[dict] = field(default_factory=list)
    stripe_connected_accounts: list[dict] = field(default_factory=list)
    stripe_charges: list[dict] = field(default_factory=list)
    stripe_refunds: list[dict] = field(default_factory=list)
    stripe_disputes: list[dict] = field(default_factory=list)
    adyen_sim: list[dict] = field(default_factory=list)
    ar_credit_memos: list[dict] = field(default_factory=list)
    ar_unapplied: list[dict] = field(default_factory=list)
    inbox_extra: list[dict] = field(default_factory=list)
    later_ar: list[dict] = field(default_factory=list)
    okta_export: list[dict] = field(default_factory=list)
    payroll_tax_941: list[dict] = field(default_factory=list)
    inventory_bins: list[dict] = field(default_factory=list)
