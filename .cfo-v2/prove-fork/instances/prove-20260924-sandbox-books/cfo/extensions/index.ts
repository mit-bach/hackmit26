 ...
 *
 *   HARNESS_BOT=ap HARNESS_COMPUTER=.cfo-v2/prove-fork/computer \
 *     pi -e .harness/Harness-v2/extensions/index.ts \
 *        -e .cfo-v2/prove-fork/computer/cfo/extensions/index.ts \
 *        --name ap
 *
    ...
    execute: async (_id, params) => {
      ...
      const result = await callConnectedTool(
        ...
        files.catalog,
        {
          ...
          idempotencyKey: key.length > 0 ? key : undefined,
        },
        undefined,
        null,
