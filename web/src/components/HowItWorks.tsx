  ...
  return (
    <section className="showcase-section" id="how-it-works">
      ...
      <div className="example-strip">
        <div className="card">
          <h3>Reading incoming email</h3>
          <p>Maximor reads finance mail and attachments before anyone books a bill.</p>
        </div>
        <div className="card">
          <h3>Deciding what the document is</h3>
          <p>It separates invoices, quotes, receipts, vendor bills waiting to be paid, and money customers still owe.</p>
        </div>
        <div className="card">
          <h3>Checking the money trails</h3>
          <p>It tests whether bank activity agrees with the accounting records, customer payments, and Stripe payouts.</p>
        </div>
      </div>
    </section>
  );
