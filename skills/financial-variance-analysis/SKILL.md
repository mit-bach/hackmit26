...
Apply when the Variance Analysis Agent or Reporting Reviewer Agent receives a computed `VarianceExplanation`. Python has already totaled the ledger, ranked contributors, and isolated the residual.
