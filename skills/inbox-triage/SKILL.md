...
Give the Finance Inbox Agent a consistent way to decide what an inbound message is and which registered action to dispatch.

## When to Use

Apply after a message has been delivered by the Counterparty Message Agent. Use for invoices, purchase orders, goods receipts, statements, quotes, remittances, payment confirmations, credit memos, bank notices, internal requests, and non-finance mail.
