...
def write_plan_packet(
    ...
    *,
    ...
    path = computer_root / "runs" / "pay" / "plans" / f"{plan_id}.json"
    write_json_atomic(
        path,
        {
            "plan_id": plan_id,
...
def write_ctl_pay_wake(
    ...
    *,
    ...
    wake_path = computer_root / "runs" / "pay" / "wakes" / f"{handle_id}.json"
...
def write_cash_wake(
    ...
    *,
    ...
    path = computer_root / "runs" / "cash" / "wakes" / f"{handle_id}.json"
